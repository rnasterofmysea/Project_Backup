...
console.log("수정값"+e.target.id.value, e.target.location.value, e.target.pay.value)
onJobEditToggle();
}
          ...
          <div className="Schedule-Template">
            <div className="ScheduleLeft">
              <FullCalendar
                ...
                eventClick={(e) => {
                  ...
                  setEvent({
                    job: e.event.title,
                    start: moment(e.event.start).format("hh:mm"),
                    end: moment(e.event.end).format("hh:mm")
                  })
            ...
            <div className="ScheduleRight">
              ...
              <div className="Calender-Event">
                {ScheduleInsertToggle && <ScheduleInsert onInsertToggle={onScheduleInsertToggle} setChange={setChange} />}
                {ScheduleToggle && <ScheduleDelete onScheduleToggle={onScheduleToggle} editID={editID} setChange={setChange} />}
                {ScheduleToggle && <ScheduleEdit onScheduleToggle={onScheduleToggle} editID={editID} setChange={setChange} />}
              </div>
                      ...
                      <SwiperSlide key={index.id} className='swiper-slide'>
                        <div className="swiper-wrapper">
                          <div className="jobItem">
                            <div className="jobItemTitle">{index.job} <JobDelete delID={index.id} /> <button onClick={onJobEditToggle}><TiPencil /></button></div>
