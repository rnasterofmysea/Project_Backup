...
const EditAcount = () =>{
    ...
    async function signIn() {
        console.log("이벤트 중계");
        try {
            const res = await axios("http://localhost:3001/editAcount", {
                method: "Post",
                params: {
                    id: params.id,
                    pw: pw1
        ...
        <>
            ...
            <div style={titleStyle}>
                ...
                <div style={{ marginBottom: "3vh" }}>
                    <div style={{ fontSize: "2vw" }}>Edit Acount</div>
                    <div style={{textAlign:"left", marginLeft: "14vw", marginTop:"2vh"}}>
                        <div>
                            new Password <input type="text" name="pw" onChange={e => setPw1(e.target.value)} />
                        </div>
                        <div>
