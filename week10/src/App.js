...
import ScheduleInsert from "./component/ScheduleInsert";
import ScheduleDelete from "./component/ScheduleDelete";
import ScheduleEdit from "./component/ScheduleEdit";
import JobDelete from "./component/JobDelete";
import JobInsert from "./component/JobInsert";
                    ...
                    inputJob.map((index) =>
                      <SwiperSlide>
                        <div className="jobItem">
                          <div className="jobItemTitle">{index.job} <JobDelete delID={index.id} /></div>
